...
def process_slides():
  with codecs.open('html/lecture01.html', 'w', encoding='utf8') as outfile:
    md = codecs.open('markdown/lecture01.md', encoding='utf8').read()
    md_slides = md.split('\n---\n')
    ...
    template = jinja2.Template(open('html/base.html').read())
